...
function Header({ isCustomHeader, customHeaderClass }) {
  ...
  return (
    <header
      ...
      className={
        // state.scrollY > 120
        // ? isCustomHeader ? `${customHeaderClass} header-area bg-color2 sticky` : "header-area style-1 bg-color2 sticky"
        // : isCustomHeader ? `${customHeaderClass} header-area style-1 bg-color2` : "header-area style-1 bg-color2" 
        // ?
        //  isCustomHeader ? `${customHeaderClass} header-area bg-color2 sticky` : "header-area style-1 bg-color2 sticky"
        // :
        isCustomHeader ? `${customHeaderClass} header-area style-1 bg-color2 sticky` : "header-area style-1 bg-color2"
      }
    >
      <div className="container-fluid d-flex justify-content-between align-items-center">
        ...
        >
          ...
          <ul className="menu-list">
            ...
            {currentRoute !== "/" ? (
              <>
                ...
                <li>
                  <Link
                    href="/home"
                    className={currentRoute === "/home" ? "active" : "disable"}
                  >
                    Home
                  </Link>
                </li>
            ...
            {/* <li>
              <Link
                href="/cart"
                className={currentRoute === "/cart" ? "active" : "disable"}
              >
                Cart
              </Link>
            </li> */}
        ...
        <div className="nav-right d-flex align-items-center">
          <div className="d-none d-lg-flex align-items-center">
            {state.mobileMenuState == true ? null : (
              <>
                {/* Contact and Cart Links */}
                <div className="mx-2">
                  <Link legacyBehavior href="/contact" className="btn-md">
                    <a className="">
                      <i class="fa fa-phone" style={{ fontSize: "24px", color: "black" }}></i>
                    </a>
                  </Link>
                </div>
                <div className="mx-2">
                  <Link legacyBehavior href="/cart" className="btn-md">
                    <a className="">
                      <i class="fa fa-shopping-cart" style={{ fontSize: "24px", color: "black" }}></i>
                    </a>
                  </Link>
                </div>
                {/* User/Login Dropdown */}
                  ...
                  {user ? (
                    <div style={{ position: "relative" }}>
                      <div
                        ...
                        className="user-avatar d-flex align-items-center justify-content-center bg-white text-white rounded-circle"
                    ...
                    <Link href="/login" className="primary-btn btn-md">
                      Login
                    </Link>
                  )}
                </div>
